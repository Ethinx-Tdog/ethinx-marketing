  ...
  return (
    <section className="text-center">
      ...
      <h1 className="mt-6 text-4xl md:text-5xl font-semibold">
        AI-Generated <span style={{color:"#D4A574"}}>Professional Headshots</span>
      </h1>
      ...
      <div className="mt-8 flex justify-center gap-3">
        ...
        <a href="/pricing" className="rounded-lg bg-[#D4A574] px-5 py-2 font-medium text-black">View pricing</a>
      </div>
    </section>
  );
}
