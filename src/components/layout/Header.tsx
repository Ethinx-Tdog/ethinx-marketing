...
export default function Header() {
  ...
  return (
    <header className="sticky top-0 z-50 border-b border-border bg-background/80 backdrop-blur-xl overflow-visible">
      ...
      {/* Mobile Drawer */}
      <div
        className={`fixed inset-y-0 right-0 z-50 w-full max-w-xs border-l border-border bg-background shadow-2xl transform transition-transform duration-300 ease-out lg:hidden ${
